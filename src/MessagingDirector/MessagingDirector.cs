namespace MessagingDirector
{
    ...
    public class MessagingDirector : Actor, IMessagingDirector
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<int> IMessagingDirector.GetCountAsync(CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        Task IMessagingDirector.SetCountAsync(int count, CancellationToken cancellationToken)
        {
